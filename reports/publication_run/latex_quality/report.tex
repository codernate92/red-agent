...
\item Highest measured aggregate risk: \textbf{gemini-2.5-pro} with risk score \textbf{7.60}.
\item Highest StrongREJECT overall score: \textbf{gemini-2.5-pro} at \textbf{0.000}.
\item Most effective technique across completed runs: \textbf{Tool Permission Probing} with mean score \textbf{0.000}.
\item Highest probe error rate: \textbf{gemini-2.5-pro} at \textbf{45\%}.
\item Registry preflight blocked \textbf{0} configured aliases, preventing those rows from being treated as true negatives.
\end{itemize}
\begin{figure}[H]
\centering
...
The reachable subset comprised 11 completed models; blocked providers accounted for 0 configured aliases.
...
The campaign type was \emph{full}; the evaluator was \emph{None}; the judge model was default.
